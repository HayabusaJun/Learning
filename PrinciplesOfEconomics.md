...
### 第26章 储蓄、投资和金融体系
* **金融体系**（financial system）：经济中促进一个人的储蓄和另一个人的投资相匹配的一组机构。
* **金融市场**（financial market）：储蓄者可以借以直接向借款者提供资金的金融机构。
	* 债券市场、股票市场
* **债券**（bond）：一种债务证明，也被称作借据（IOU）
	* 期限：短期、长期、永久
	* 信用风险
	* 税收待遇（是否享受政府的税收减免政策）
* **股票**（stock）：企业部分所有权的索取权。
	* 价格
	* 红利。没有支付的利润称为**留存收益**。**红利收益率**：红利与股价的百分比
	* 价格-收益比：每股收益/股票价格（**PE**）。一般在15左右
* 出售股票股票筹集资金称为**权益融资**。
	* 出售的是公司的所有权
* 出售债券筹集资金称为**债务融资**。
	* 出售的是公司的债权
* 如果企业利润丰厚，股票所有者享有利润的利益，债权人只享有债务的利息；如果企业亏损，债权人优先享有获得补偿的权利。
* **金融中介机构**（financial intermediaries）：储蓄者可以借以间接的向借款者提供资金的金融机构。
	* 银行：帮助创造一种人们可以借以作为交换媒介的特殊资产（支票、借记卡），使人们更加方便的进行交易。
	* **共同基金**（mutual fund）：向公众出售股份，并用收入来购买股票与债券资产组合的机构。方便人们进行多元化投资。
* **国民储蓄**（national saving）：或简称**储蓄**（saving），在用于消费和政府购买后剩下的一个经济中的总收入。
* **私人储蓄**（private saving）：家庭在支付了税收和消费之后剩下的收入。
* **公共储蓄**（public saving）：政府在支付其支出后剩下的税收收入。
* **预算盈余**（budget surplus）：税收收入大于政府支出的余额。
* **预算赤字**（budget deficit）：政府支出引起的税收收入短缺。
* 对于整个经济体而言，储蓄必定等于投资。
* **可贷资金市场**（market for loanable funds）：想储蓄的人借以提供资金、想借钱投资的人借以借贷资金的时长。
	* 储蓄是可贷资金供给的来源
	* 投资是可贷资金需求的来源
* **挤出**（crowding out）：政府借款所引起的投资减少。

### 第27章 金融学的基本工具
* **金融学**（finance）：研究人们如何在某一时期内做出关于**配置资源**和**应对风险**的决策的学科。
* **现值**（present value）：用现行利率产生一定量未来货币所需要的现在货币量。
* **终值**（future value）：在现行利率下既定时，现在货币量将带来的未来货币量。
* **复利**（compounding）：货币量的累积，比如说银行账户上货币量的累积，即赚得的利息仍留在账户上以赚取未来更多的利息。
* 寻找一定量未来货币现值的过程称为**贴现**。
* **风险厌恶**（risk aversion）：不喜欢不确定性。
	* 根据效用函数，一个人对福利或满足的主观衡量，随着边界效用递减的性质逐渐降低
	* 人们是风险厌恶者
* 风险厌恶的规避方式：保险、多元化
* **多元化**（diversification）：通过用大量不相关的小风险代替一种风险来降低风险。
* **企业特有风险**（firm-specific risk）：只影响一家公司的风险。
* **市场风险**（market risk）：影响股市上左右公司的风险。
* 多元化可以消除企业特有风险，但是不能消除市场风险。
* **基本面分析**（fundamental analysis）：为决定一家公司的价值而对其会计报表和未来前景进行的研究。
* 一种资产的价值等于所有者将得到的现金流的价值。股票的现金流包括红利流量以及最终的出售价格。
* **有效市场假说**（efficient markets hypothesis）：认为资产价格反映了关于一种资产价值的所有公开的、可获得的信息的理论。
	* 机构每天都在关注并进行资产的基本面分析
	* 供需均衡决定了市场价格
* **信息有效**（informational efficiency）：以理性方式反应所有可获得的信息的有关资产价格的描述。
	* 根据有效市场假说，股票价格是信息有效的：当信息改变时，股票的价格就会变动。
* **随机游走**（random walk）：一种不可预期的变量变动的路径。
	* 因为新闻不可预期，所以股票价格也不可预期
	* 反对有效市场假说

### 第28章 失业
* **自然失业率**（natural rate of unemployment）：经济中正常情况下存在的失业量。失业率围绕它而波动的正常失业率。
* **周期性失业率**（cyclical unemployment）：围绕着自然失业率逐年波动，与经济活动的短期上升和下降密切相关。失业率对自然失业率的背离。
* **劳动力**（labor force）：既包括就业者又包括失业者的劳动力总和。
* **失业率**（unemployment rate）：劳动力中失业者所占的百分比。
* 成年人口 = 就业者 + 失业者 + 非劳动力（全日制学生、家务劳动者、退休人员）
* **劳动力参工率**（labor-force participation rate）：劳动力占成年人口的百分比。
* **丧失信心的工人**（discourage workers）：想工作但已放弃寻找工作的人。
* 大多数失业是短期的，而在任何一个既定时间段内所观察到的大多数失业又是长期的。
	* 成为失业者的大多数人将很快找到工作，而经济中的大部分失业问题是由少数长期没有工作的工人所造成的
* **摩擦性失业**（frictional unemployment）：由于工人寻找最合适自己嗜好和技能的工作需要时间而引起的失业。
* **结构性失业**（structural unemployment）：由于某些劳动市场上可提供的工作岗位数量不足而引起的失业。
* 各行业或各地区之间的需求构成变动称为**部门转移**。
* 如果工资由于任何一种原因高于均衡水平，就会导致失业。从公会高工资中得到好处的局内人与没有得到公会工作岗位的局外人之间产生冲突。创造出了过剩的劳动供给。
* **集体谈判**（collective bargaining）：公会和企业就就业条件达成一致的过程。
* 效率工资的优势：
	* 提高工人健康
	* 降低工人流动率
	* 提高工人素质（招到更优秀的员工）
...
* **商品货币**（commodity money）：以有内在价值的商品为形式的货币。（金本位、香烟）
* **法定货币**（fiat money）：没有内在价值，由政府法令确定作为通货使用的货币。
* **通货**（currency）：公众手中持有的纸币钞票和铸币。
* **活期存款**（demand deposits）：储户可以通过开支票而随时支取的银行账户余额。
* M1：通货、活期存款、支票
* M2：储蓄存款、小额定期存款、共同基金等次重要项目 + M1
* 信用卡不是货币，只是一种延期支付方式。
* **联邦储备局**（Federal Reserve，Fed）：美国央行。
	* 向银行提供贷款
	* 银行流动资金出现短缺时的**最后还贷者**
* **中央银行**（central bank）：为了监管银行体系和调节经济中的货币量而设计的机构。
* **货币供给**（money supply）：经济中可得到的货币量。
	* 由家庭储蓄的货币量和银行选择的贷款量共同决定
* **货币政策**（money policy）：中央银行的决策者对货币供给的安排。
* **准备金**（reserves）：银行得到但没有贷出去的存款。
	* 如果银行以准备金形式持有**所有**存款，银行就不影响货币供给。
* **部分准备金制度**（fractional-reserve banking）：只把部分存款作为准备金的银行制度。
	* 当银行只把部分存款作为准备金时，银行创造了货币
* **准备金率**（reserve ratio）：银行作为准备金持有的存款比率。
	* 准备金率越高，货币乘数越小，银行可贷出去的货款越少
* **货币乘数**（money multiplier）：银行体系用1美元准备金所产生的货币量。
* **杠杆**（leverage）：将借到的货币追加到用于投资的现有资金上。
* **杠杆率**（leverage ratio）：资产与资本的比率。
* **资本需要量**（capital requirement）：政府管制确定的最低银行资本量。
* **公开市场操作**（open-market operation）：美联储控制货币供给的方式。
	* 买卖美国政府债券
	* 调整贴现率
	* 调整法定准备金率
* **贴现率**（discount）：美联储向银行发放贷款的利率。
	* 短期拍卖：向美联储贷款的新机制，有可接受抵押品并愿意支付最高利率的银行获得贷款
* **法定准备金**（reserve requirements）：关于银行必须根据其存款持有的最近准备金的规定。
* 支付准备金利息：银行在以美联储的存款持有准备金时美联储提供的利息
...
* **真实变量**（real variables）：按实物单位衡量的变量。也可以叫相对价格。
* **古典二分法**（classical dichotomy）：名义变量和真实变量的理论区分。
* **货币中性**（monetary neutrality）：认为货币供给变动并不影响真实变量的观点。
* **货币流通速度**（velocity of money）：货币易手的速度。
* **数量方程**（quantity equation）：M（货币数量） × V（货币流通速度） = P（物价水平——GDP平减指数） × Y（真实GDP——产量）
* 货币数量论本质：
	* 货币流通速度一直是比较稳定的。
	* 由于货币流通速度稳定，所以当中央银行改变货币量（M），引起了名义产出价值（P × Y）的同比例变动。
	* 一个经济的物品与服务的产量（Y）主要是由要素供给（劳动、物质资本、人力资本、自然资源）及可以得到生产技术决定的，特别是由于是货币是中性的，所以并不严重影响产量。
	* 在产量（Y）由要素供给和技术决定的情况下，当中央银行改变货币供给（M）并引起名义产出价值（P × Y）发生同比例变动时，这些变动反应在物价水平（P）的变动上。
	* 因此当中央银行迅速增加货币供给时，结果就是高速通货膨胀。
* **通货膨胀税**（inflation tax）：政府通过创造货币而筹集的收入。
	* 通货膨胀税就像一种向每个持有货币的人征收的税
* **费雪效应**（Fisher effect）：名义利率对通货膨胀所进行的一对一的调整。
* 当收入的膨胀和物价的膨胀同步时，通货膨胀本身并没有降低人么的实际购买力。
* 通货膨胀的成本：
	* **皮鞋成本**（shoeleather cost）：当通货膨胀鼓励人们减少货币持有量时所造成的浪费（兑换成保值外币或者贵金属的成本）
	* **菜单成本**（menu cost）：商家改变价格的成本
	* 相对价格变动与资源配置不当：消费者的决策因为相对价格的变动而受到扭曲
	* 通货膨胀引起的税收扭曲：真实利率不等于名义利率
	* 混乱与不方便：货币作为计价单位的功能失效
	* 未预期到的通货膨胀的特殊成本：任意的财富再分配

### 第31章 开放经济的宏观经济学：基本概念
* **封闭经济**（closed economy）：不与世界上其他经济相互交易的经济。
* **开放经济**（open economy）：与世界上其他经济自由交易的经济。
* **出口**（export）：在国内生产而在国外销售的物品与服务。
* **进口**（import）：在国外生产而在国内销售的物品与服务。
* **净出口**（net exports）：一国的出口值减进口值，也称作**贸易余额**（trade balance）。
* 影响一国出口、进口和净出口的因素：
	* 消费者对国内与国外物品的嗜好
	* 国内与国外物品的价格
	* 人们可以用国内通货购买国外通货的汇率
	...
	* 从一国向另一国运送物品的成本
	* 政府对国际贸易的政策
* **资本净流出**（net capital outflow）：本国居民购买外国资产减外国人购买的本国资产。
* 一些影响资本净流出的较重要因素：
	* 国外资产得到的真实利率
	* 国内资产得到的真实利率
	* 持有国外资产可以觉察到的经济与政治风险
...
* **升值**（appreciation）：按所能购买到的外国通货量的一国通货的价值增加——坚挺。
* **贬值**（depreciation）：按所能购买到的外国通货量的一国通货的价值减少——疲软。
* **真实汇率**（real exchange rate）：一个人可以用一国的**物品与服务**交换另一国的**物品与服务**的比率。
* **购买力平价**（purchasing-power parity）：一种认为任何一单位通货应该能在所有国家买到等量物品的汇率理论。
	* 根据一价定律得出。如果不同市场上同一种商品存在价格差，那么就存在套利的空间，价格会自发的进行调整。
* 如果1美元的购买力在国内和国外总是相同的，那么真实汇率——国内物品和国外物品的相对价格——就不会改变。
* 根据购买力平价理论，两国通货之间的名义汇率必然反映这两个国家的物价水平。
* 当中央银行印发了大量货币时，无论根据它能买到的物品与服务，还是根据它能买到的其他通货，这种货币的价值都减少了（贬值）。
* 购买力平价理论的局限性：
	* 许多物品是不容易进行贸易的
	* 可贸易物品在不同国家生产时也不总能被完全替代

### 第32章 开放经济的宏观经济理论
* 一国可贷资金市场 = 国内投资（可贷资金市场） + 净资本流出（外汇市场）
* 在均衡利率时，人们想储蓄的量正好与合意的国内投资和资本净流出量平衡。
* 在均衡的真实汇率下，由美国**物品与服务净出口**所引起的外国人对美元的需求正好与由美国**资本净流出**所引起的来自美国人的美元供给相平衡。

【开放经济的实际均衡】

![avatar](https://github.com/HayabusaJun/Learning/raw/master/ImageHostingForPriciplesOfEconomics/realBalanceOfOpenEconomy.png)

* 政务预算赤字时：
	* 预算赤字（公共储蓄减少）减少了可贷资金的供给
	* 提高了真实利率
	* 减少了资本净流出
	* 用于兑换外国通货的美元供给减少
...
* 关于经济波动的三个关键事实：
	...
	* 大多数宏观经济变量同时波动
	* 随着产量减少，失业增加
* 古典理论（货币只是名义变量，不影响物物交换的实际变量）描述长期世界，但没有描述短期世界。
...
* 财富效应：物价水平的下降提高了货币的真实价值，并使消费者更富有，这又鼓励他们更多的支出——消费者更富有。
* 利率效应：物价水平的下降降低了利率，鼓励更多的用于投资品的支出，从而增加了物品与服务的需求量（信贷消费）——利率下降。
* 汇率效应：物价水平的下降引起利率下降时，通货在外汇市场上的真实价格下降了，这种贬值刺激了净出口，从而增加了物品与服务的需求量——货币贬值。
* 引起总需求曲线移动的原因：消费（税率、股市）、投资（未来经济预估）、政府购买（国防与基础建设投资）、净出口（国外经济情况，汇率）
* 在长期中，一个经济的物品与服务生产（真实GDP）取决于劳动、资本、自然资源和技术
...
![avatar](https://github.com/HayabusaJun/Learning/raw/master/ImageHostingForPriciplesOfEconomics/longTermIncreaseAndInflation.jpg)

* 应该把产量与物价水平的短期波动视为对持续的产量增长和通货膨胀长期趋势的背离。
* 当经济中的实际物价水平背离了人们预期的物价水平时，供给量就背离了其长期水平或自然水平。所以短期中物价水平确实影响经济的产量。
* 短期总供给曲线向右上方移动而非垂直的原因：
	* 黏性工资理论：工资的调整相较于经济状况的变动具有滞后性
	* 黏性价格理论：菜单成本
	* 错觉理论：物价总水平的变动会暂时误导供给者的产量

![avatar](https://github.com/HayabusaJun/Learning/raw/master/ImageHostingForPriciplesOfEconomics/totalDemandReduce.jpg)
...
* 总需求减少分析
	...
	* 产量恢复到自然水平
	* 相较之前的供给平衡状态，物价下降
* 短期中，总需求移动引起经济中物品与服务产量的波动
* 长期中，总需求移动影响物价总水平，但不影响产量
* 证券化：金融机构进行贷款，然后（通过投资银行帮助）将贷款捆绑为金融工具（证券），卖给其他金融机构。
* **滞涨**（stagflation）：产量减少而价格上涨的时期。
* 工资-物价螺旋式上升：高工资引起高物价，高物价又引起更高的工资。
* 政策如何抵消总供给的不利移动：
	* 当短期总供给减少时
	* 决策者可以通过扩大总需求来抵消供给减少
	* 引起物价水平进一步上升
